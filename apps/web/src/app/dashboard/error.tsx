    ...
    <div className="flex flex-1 flex-col items-center justify-center overflow-hidden px-4 py-16">
      <div className="max-w-md rounded-2xl border border-rose-200 bg-white p-8 text-center shadow-sm">
        ...
        <button
          type="button"
          onClick={() => reset()}
          className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-[#a78bfa] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#8b5cf6]"
        >
