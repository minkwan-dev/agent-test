  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#f2f4f6]">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-16">
        <p className="text-sm font-bold uppercase tracking-wider text-[#3182f6]">404</p>
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          >
            <Home className="h-4 w-4 text-[#3182f6]" />
            홈으로
          </Link>
          <Link
            href="/dashboard/overview"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#3182f6] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#256dd4]"
          >
        ...
        <Link
          href="/"
          className="mt-8 inline-flex items-center gap-1.5 text-sm font-medium text-[#8b95a1] transition hover:text-[#3182f6]"
        >
