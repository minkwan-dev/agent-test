          ...
          */}
          ...
          {!panelOpen ? (
            <button
              ...
              className="fixed bottom-5 right-5 z-[150] flex h-12 w-12 items-center justify-center rounded-full bg-[#a78bfa] text-white shadow-lg shadow-[#a78bfa]/20 transition hover:bg-[#8b5cf6] lg:hidden"
              title="AI 어시스턴트"
              aria-expanded={false}
