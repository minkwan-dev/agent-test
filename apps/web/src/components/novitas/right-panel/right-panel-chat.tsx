    ...
    <div className="flex min-h-0 flex-1 flex-col bg-[#f9fafb]">
      <div className="scrollbar-thin flex-1 space-y-4 overflow-y-auto p-4">
        <div className="text-center">
          <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#e4f6ee] to-[#f5faf8] text-2xl">
            🤖
          </div>
          ...
          >
            <div
              className={cn(
                ...
                m.role === "user"
                  ? "rounded-br-md bg-[#6eb89a] text-white"
      ...
      <div className="flex shrink-0 gap-2 border-t border-[#e5e8eb] bg-white p-3">
        <textarea
          ...
          rows={2}
          className="min-h-[44px] flex-1 resize-none rounded-xl border border-[#e5e8eb] bg-[#f9fafb] px-3 py-2 text-sm text-[#191f28] placeholder:text-[#8b95a1] outline-none focus:border-[#6eb89a] focus:ring-1 focus:ring-[#6eb89a]/30"
        />
        <button
          type="button"
          onClick={onSend}
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#6eb89a] text-white transition hover:bg-[#5aa688]"
          aria-label="전송"
        >
          <svg
            width="18"
