...
export function FaqSideVisual() {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-[#e5e8eb] bg-gradient-to-br from-[#f5f3ff] via-white to-[#f8fafc] p-8 shadow-sm">
      <div className="absolute -right-6 -top-6 h-32 w-32 rounded-full bg-[#a78bfa]/10 blur-2xl" />
      <div className="absolute -bottom-8 left-4 h-24 w-24 rounded-full bg-[#e9d5ff]/20 blur-xl" />
