          ...
          {landingFlowSteps.map((s, i) => (
            <Fragment key={s.n}>
              <div className="relative z-10 flex min-w-0 flex-1 flex-col items-center">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border-2 border-white bg-[#3182f6] text-sm font-bold text-white shadow-lg sm:h-16 sm:w-16 sm:text-base">
                  {s.n}
                </div>
